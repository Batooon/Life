    ...
    public class Field
    {
        ...
        private Cell[] GetCellNeighbours(int x, int y)
        {
            ...
            else if (x == 0 && y > 0 && y < _height - 1) // левая стенка
            {
                ...
                neighbours[1] = _cells[1, y - 1];
                neighbours[2] = _cells[1, y];
                neighbours[3] = _cells[1, y + 1];
            ...
            else if (y == 0 && x > 0 && x < _width - 1) // нижняя стенка
            {
                ...
                neighbours[1] = _cells[x - 1, 1];
                neighbours[2] = _cells[x, 1];
                neighbours[3] = _cells[x + 1, 1];
            ...
            else if (x == 0 && y == 0) // левый нижний угол
            {
                ...
                neighbours[2] = _cells[x, 1];
                neighbours[1] = _cells[1, 1];
                neighbours[0] = _cells[1, y];
            }
